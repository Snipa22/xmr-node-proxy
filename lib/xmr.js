...
function blobTypeGrin(blob_type_num) {
    return blob_type_num == 8 || blob_type_num == 9 || blob_type_num == 10;
}
...
function hash_func(convertedBlob, blockTemplate) {
    ...
    switch (algo2) {
        ...
        case 'panther':                return multiHashing.randomx(convertedBlob, Buffer.from(blockTemplate.seed_hash, 'hex'), 3);
