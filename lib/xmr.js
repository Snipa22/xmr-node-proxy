...
function hash_func(convertedBlob, blockTemplate) {
    switch (typeof(blockTemplate.algo) === 'undefined' ? "cn/r" : blockTemplate.algo) {
        case 'cn':
        case 'cryptonight':
        case 'cn/0':
        ...
        case 'argon2/chukwa':
        case 'chukwa':                 return multiHashing.argon2(convertedBlob, Buffer.from(blockTemplate.seed_hash, 'hex'), 0);

        case 'argon2/wrkz':            return multiHashing.argon2(convertedBlob, Buffer.from(blockTemplate.seed_hash, 'hex'), 1);
    }
    return "";
}
